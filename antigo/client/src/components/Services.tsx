                  ...
                  <div className="p-4 sm:p-5 md:p-6 lg:p-7 flex flex-col flex-1">
                    ...
                    <div className="space-y-1 sm:space-y-2 mb-4 sm:mb-6">
                      {service.benefits.map((benefit) => (
                        <div key={benefit} className="flex items-center text-xs sm:text-sm text-gray-600">
                          <div className="w-1 sm:w-1.5 h-1 sm:h-1.5 bg-primary rounded-full mr-2 sm:mr-3 flex-shrink-0"></div>
                          {benefit}
                        </div>
                      ))}
                    </div>
